...
public class MachineOrganicMaterialWorkerUpdateTickProcedure extends BedrockutilsModElements.ModElement {
	public MachineOrganicMaterialWorkerUpdateTickProcedure(BedrockutilsModElements instance) {
		super(instance, 225);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				BedrockutilsMod.LOGGER.warn("Failed to load dependency x for procedure MachineOrganicMaterialWorkerUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				BedrockutilsMod.LOGGER.warn("Failed to load dependency y for procedure MachineOrganicMaterialWorkerUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				BedrockutilsMod.LOGGER.warn("Failed to load dependency z for procedure MachineOrganicMaterialWorkerUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				BedrockutilsMod.LOGGER.warn("Failed to load dependency world for procedure MachineOrganicMaterialWorkerUpdateTick!");
			return;
		}
		...
		if (!world.isRemote()) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("getFluidAmount", (new Object() {
		...
		if (!world.isRemote()) {
			...
			if (_tileEntity != null)
				...
				}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "getFluidAmount")) * 100) / (new Object() {
					public double getValue(IWorld world, BlockPos pos, String tag) {
						TileEntity tileEntity = world.getTileEntity(pos);
						if (tileEntity != null)
							return tileEntity.getTileData().getDouble(tag);
		...
		}
		{
			...
			UpgradeSettingMachineProcedure.executeProcedure($_dependencies);
		}
		if (((new Object() {
			public double getValue(IWorld world, BlockPos pos, String tag) {
				TileEntity tileEntity = world.getTileEntity(pos);
			...
			if ((!(new Object() {
			...
			}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "recycleUpgrade")))) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					MachineOrganicMaterialWorkerRecipeJuiceProcedure.executeProcedure($_dependencies);
				}
			} else {
				{
					Map<String, Object> $_dependencies = new HashMap<>();
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					MachineOrganicMaterialWorkerRecipeRecycleProcedure.executeProcedure($_dependencies);
				}
			}
		}
		if (((((new Object() {
		...
		}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "getFluidAmount")) >= 1000) && ((new Object() {
