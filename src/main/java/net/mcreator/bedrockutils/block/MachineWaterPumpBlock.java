...
import net.mcreator.bedrockutils.procedures.MachineWaterPumpUpdateTickProcedure;
import net.mcreator.bedrockutils.procedures.MachineWaterPumpBlockAddedProcedure;
import net.mcreator.bedrockutils.itemgroup.BedrockUtilsItemGroup;
import net.mcreator.bedrockutils.gui.MachineWaterPumpGUIGui;
...
public class MachineWaterPumpBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:machine_water_pump")
	public static final Block block = null;
	@ObjectHolder("bedrockutils:machine_water_pump")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public MachineWaterPumpBlock(BedrockutilsModElements instance) {
		super(instance, 279);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("machine_water_pump"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(15f, 2000f).setLightLevel(s -> 0)
					.harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH).with(WATERLOGGED, false));
			setRegistryName("machine_water_pump");
		}
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 5);
			{
				...
				MachineWaterPumpBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MachineWaterPumpUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 5);
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Water Pump");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new MachineWaterPumpGUIGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("machine_water_pump");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new MachineWaterPumpGUIGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
