...
public class BlockBedrockFenceBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:block_bedrock_fence")
	public static final Block block = null;
	public BlockBedrockFenceBlock(BedrockutilsModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("block_bedrock_fence");
		}
