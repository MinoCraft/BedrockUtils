...
import net.mcreator.bedrockutils.procedures.FluidTankUpdateTickProcedure;
import net.mcreator.bedrockutils.itemgroup.BedrockUtilsItemGroup;
import net.mcreator.bedrockutils.gui.FluidTankGUIGui;
...
public class FluidTankBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:fluid_tank")
	public static final Block block = null;
	@ObjectHolder("bedrockutils:fluid_tank")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public FluidTankBlock(BedrockutilsModElements instance) {
		super(instance, 249);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				FluidTankUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
