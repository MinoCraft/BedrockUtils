...
import net.mcreator.bedrockutils.procedures.ComparatorExtendedUpdateTickProcedure;
import net.mcreator.bedrockutils.procedures.ComparatorExtendedOnBlockRightClickedProcedure;
import net.mcreator.bedrockutils.procedures.ComparatorExtendedNeighbourBlockChangesProcedure;
import net.mcreator.bedrockutils.procedures.ComparatorExtendedBlockAddedProcedure;
...
public class ComparatorExtendedBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:comparator_extended")
	public static final Block block = null;
	@ObjectHolder("bedrockutils:comparator_extended")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ComparatorExtendedBlock(BedrockutilsModElements instance) {
		super(instance, 72);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry()
					.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("comparator_extended"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
			{
				...
				ComparatorExtendedBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ComparatorExtendedNeighbourBlockChangesProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("comparator_extended");
		}
