...
public class BlockBedrockSlabBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:block_bedrock_slab")
	public static final Block block = null;
	public BlockBedrockSlabBlock(BedrockutilsModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("block_bedrock_slab");
		}
