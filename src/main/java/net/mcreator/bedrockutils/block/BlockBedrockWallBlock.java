...
public class BlockBedrockWallBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:block_bedrock_wall")
	public static final Block block = null;
	public BlockBedrockWallBlock(BedrockutilsModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("block_bedrock_wall");
		}
