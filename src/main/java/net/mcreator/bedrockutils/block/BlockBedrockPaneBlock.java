...
public class BlockBedrockPaneBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:block_bedrock_pane")
	public static final Block block = null;
	public BlockBedrockPaneBlock(BedrockutilsModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("block_bedrock_pane");
		}
