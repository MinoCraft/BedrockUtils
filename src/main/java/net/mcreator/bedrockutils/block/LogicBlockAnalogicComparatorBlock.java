...
public class LogicBlockAnalogicComparatorBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:logic_block_analogic_comparator")
	public static final Block block = null;
	@ObjectHolder("bedrockutils:logic_block_analogic_comparator")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public LogicBlockAnalogicComparatorBlock(BedrockutilsModElements instance) {
		super(instance, 127);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(
					TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("logic_block_analogic_comparator"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("logic_block_analogic_comparator");
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("logic_block_analogic_comparator");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Analogique Comparator");
		}
