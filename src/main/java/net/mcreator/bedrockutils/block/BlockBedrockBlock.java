...
public class BlockBedrockBlock extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:block_bedrock")
	public static final Block block = null;
	public BlockBedrockBlock(BedrockutilsModElements instance) {
		super(instance, 39);
	}
