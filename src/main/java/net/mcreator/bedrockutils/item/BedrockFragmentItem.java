...
public class BedrockFragmentItem extends BedrockutilsModElements.ModElement {
	@ObjectHolder("bedrockutils:bedrock_fragment")
	public static final Item block = null;
	public BedrockFragmentItem(BedrockutilsModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bedrock_fragment");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Break Bedrock to obtain !"));
		}
	}
}
